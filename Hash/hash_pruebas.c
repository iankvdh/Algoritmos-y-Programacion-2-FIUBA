...
static void prueba_hash_iterar_volumen(size_t largo)
{
    ...
    for (i = 0; i < largo; i++) {
        ...
        if ( valor == NULL ) {
            ok = false;
            ///////////////////////////////////////////////////////////////////////////
            printf("\nACA ESTA FALLANDO:  i = %d\n\n", i);
            //Fijate que si arreglamos esta se arreglan todas las demas. Porque al romper aca
            //Deja de iterar haciendo que fallen las demas también.
            ///////////////////////////////////////////////////////////////////////////
            break;
        }
        *valor = largo;
